...
@Component({
    ...
    template: ` <div class="layout-topbar">
        <div class="layout-topbar-logo-container">
            ...
            <a class="layout-topbar-logo" routerLink="/diagnofirm">
...
<div class="layout-topbar-menu hidden lg:block">
  <div class="layout-topbar-menu-content">
    ...
    <button
      ...
      <span>{{ username }}</span>
      <i class="pi pi-angle-down" style="font-size: 0.75rem; margin-left: 4px;"></i>
    </button>
...
export class AppTopbar {
    ...
    ngOnInit() {
        // 👇 update key to match what you stored at login
